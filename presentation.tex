...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Example 1: pop edx $\rightarrow$ \regex{\^{}.* pop edx ; .*ret}
        \item Example 2: int 0x80 $\rightarrow$ \regex{\^{}.* int 0x80}
        \item Example 3: xor eax, eax $\rightarrow$ \regex{\^{}.* xor eax, eax ; .*ret}
    \end{itemize}
\end{frame}
